...
fun LemonadePage(modifier: Modifier = Modifier, onClick: () -> Unit) {
    ...
    val step = when(currentStep){
        1 -> R.string.step1_action
        2 -> R.string.step2_action
        3 -> R.string.step3_action
        else -> R.string.step4_action
    }
    ...
    Column(modifier.fillMaxSize(), horizontalAlignment = Alignment.CenterHorizontally, verticalArrangement = Arrangement.Center) {
        Row(modifier.height(48.dp)) {
            Text(text = stringResource(id = R.string.app_name),
                modifier
                    ...
                    .fillMaxWidth()
                    .fillMaxHeight(), fontSize = 32.sp, fontWeight = FontWeight.SemiBold, textAlign = TextAlign.Center
            )
        }
        ...
        Text(text = stringResource(id = step),
            modifier = Modifier
                .weight(0.25f)
                .wrapContentSize(), fontSize = 18.sp)
    }
}
